...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnSignIn,btnSignOut,btnAddUser,btnAttendance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddUser = (Button) findViewById(R.id.add_item_screen);
        btnAttendance=(Button) findViewById(R.id.Take_Attendance);
